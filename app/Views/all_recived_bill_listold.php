                            ...
                            <div class="col-md-12 col-sm-12 List p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-warning float-end btn-lg me-2" data-bs-toggle="modal" data-bs-target="#completebill">
                                            Complete Bill
                                        </button>
                                        ...
                                        <table class="table table-bordered table-hover" id="myTable">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th><select name="Vendor_Id" class="form-control "data-live-search="true" style="width:130px;" onchange="submit()"> 
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th><select name="Unit_Id" class="form-control" id="Unit_Id" style="width:130px" onchange="submit()">
                                            ...
                                            if(isset($dax)){
                                                foreach ($dax as $row){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php if(isset($rowMasterActionUpload) && $rowMasterActionUpload!='') { if(!empty($rowMasterActionUpload['image_upload'])){ echo base_url('public/vendors/PicUploadMasterAction/'.$rowMasterActionUpload['image_upload']); }else{ }} ?>" target="_blank">link</a></a> 
                                                        </td>
