                ...
                <div class="col-md-7">
                    ...
                    <div class="form p-0">
                        ...
                        {   
                            ...
                            {  
                                echo "<div class='alert alert-danger' role='alert'>Mobile No Is Not Verified  </div>";
                            }
                        } 
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div class="text-right"> 
                                        ...
                                        <div id="VerifiedBefore">
                                            <button onclick="showMessage()" class="btn btn-success register btn-block">Register</button>
                                        </div>
                                        <div id="CaptchaButton" style="display: none;">
                                            <button onclick="CaptchashowMessage()" class="btn btn-success register btn-block">Register</button>
                                        </div>
                                        <!--*************-->
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 'success') {
                            ...
                            alert('This Mobile Number Exists!');
                        }
                    }
                });
            } else {
