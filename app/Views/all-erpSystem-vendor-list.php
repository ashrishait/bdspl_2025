                                            ...
                                            if(isset($dax)){
                                                foreach ($dax as $row){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo   date('d-m-Y', strtotime($row['Clear_Bill_Form_DateTime']))?></td>
                                                        <td><?php echo $row['Clear_Bill_Form_Status_Comments']; ?></td>
                                                        <td><?php if($row['ERP_Status']=='1'){ echo "Pending"; }elseif($row['ERP_Status']=='2'){ echo "Accepted"; }elseif($row['ERP_Status']=='3'){ echo "Rejected"; }else{ echo "Done"; } ?></td>
                                                    </tr> 
                                                    <?php 
                                                } 
                                            } 
