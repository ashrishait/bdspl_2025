                        ...
                        <div class="col-md-12 col-sm-12"> 
                           <?php
                              ...
                              {   
                                 ...
                                 {  
                                    echo "<div class='alert alert-danger' role='alert'> Aeactive User. </div>";
                                 }
                                 else{
                                    echo "<div class='alert alert-danger' role='alert'> Problem in operation! </div>";
                                 }
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                       <a id="rowAdder" type="button" class="btn btn-success float-end" href="<?php echo base_url();?>/index.php/add-user">
                                          <span class="bi bi-plus-square-dotted"></span> Add User
                                       </a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="modal-dialog modal-sm modal-dialog-centered">
                                                   <div class="modal-content">
                                                      <div class="modal-header">
                                                         <h4 class="modal-title" id="myLargeModalLabel">Login to this user</h4>
                                                            ...
                                                            <div class="row">
                                                               <div class="col-sm-12 col-md-12">
                                                                  <form method="post" action="<?php echo site_url('/DirectUserLogin'); ?>">
                                                                     ...
                                                                     <input type="hidden" name="bylogin_email" value="<?php echo $session->get("email"); ?>">
