                     ...
                     <div class="row">
                        <div class="col-lg-12 mb-lg-0 pt-0">
                           <div class="card congratulation-bg text-center py-0" style="background:none;">
                              <div class="card-body">
                                 <h2 class="mb-3 font-weight-bold">View Dashboard</h2>
                        ...
                        <div class="col"> 
                            <div class="col-12">
                                <div class="card-box bg-dark">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_bill_mapping_list?ViewOnly=1&&Satus=1');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-success">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_bill_mapping_list?ViewOnly=1&&Satus=2');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-danger">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_bill_mapping_list?ViewOnly=1&&Satus=3');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-primary">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_bill_mapping_list?ViewOnly=1&&Satus=4');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>   
                        <div class="col">
                            <div class="col-12">
                                <div class="card-box bg-dark">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_Clear_Bill_Form_list?ViewOnly=1&&Satus=1');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-success">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_Clear_Bill_Form_list?ViewOnly=1&&Satus=2');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-danger">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_Clear_Bill_Form_list?ViewOnly=1&&Satus=3');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-primary">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_Clear_Bill_Form_list?ViewOnly=1&&Satus=4');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="col-12">
                                <div class="card-box bg-dark">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_erpStystem_list?ViewOnly=1&&Satus=1');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-success">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_erpStystem_list?ViewOnly=1&&Satus=2');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-danger">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_erpStystem_list?ViewOnly=1&&Satus=3');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-primary">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_erpStystem_list?ViewOnly=1&&Satus=4');?>base_url('/index.php/all_recived_bill_list?ViewOnly=1&&Satus=1');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="col-12">
                                <div class="card-box bg-dark">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_recived_bill_list?ViewOnly=1&&Satus=1');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-success">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_recived_bill_list?ViewOnly=1&&Satus=2');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-danger">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_recived_bill_list?ViewOnly=1&&Satus=3');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="card-box bg-primary">
                                    ...
                                    <a href="<?php echo base_url('/index.php/all_recived_bill_list?ViewOnly=1&&Satus=4');?>" class="card-box-footer py-2">View More <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div> 
