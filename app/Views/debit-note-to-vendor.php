                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <div class="col-md-12 col-sm-12 List p-3">
                            <div class="row">
                                <div class="col-md-10">
                                    <form method="get" action="<?php echo site_url('/debit-note-vendor'); ?>" enctype="multipart/form-data"> 
                                        <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin">
                            <div class="col-md-12 col-sm-12 List p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <a href="<?php echo base_url('/index.php/export-debit-note-account-list'); ?>"  class="btn btn-danger float-end btn-lg">Excel Export</a>
                                        <?php
                                        if($ViewOnly==1)
                                        { }
                                        else{
