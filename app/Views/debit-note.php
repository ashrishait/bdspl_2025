                        ...
                        <div class="col-lg-12 grid-margin">
                            <div class="col-md-12 col-sm-12 List p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <a href="<?php echo base_url('/index.php/export-debit-note-list'); ?>"  class="btn btn-danger float-end btn-lg">Excel Export</a>
                                        <?php
                                        if($ViewOnly==1)
                                        { }
                                        else{
                                                ...
                                                if(isset($users)){
                                                    foreach ($users as $index => $row){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if($row['Send_Note_Status']==1){
                                                                    echo "Debit Note Added";
                                                                }
                                                                else{ ?>
                                                            ...
                                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="">
                                                                            <div class="row">   
                                                                                <form method="post" action="<?php echo site_url('/send-debit-note-to-manager'); ?>" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <div class="col-sm-12 col-md-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select name="Mapping_Acount_EmpId" class="form-control"  style="padding: 0.875rem 1.375rem" required> 
                                                                                                ...
                                                                                                ->where('asitek_employee.eligible_for_debit_note', 'Yes')
                                                                                                ->groupBy('asitek_employee.id')
                                                                                                ->findAll();
        ...
        <script>
            $(document).ready(function () {
                $('#sendtobillreceivingayaccount').click(function () {
                    ...
                    $.ajax({
                        url: '<?php echo base_url('/index.php/debit-note-send-to-manager') ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: formData,
                        contentType: false,
