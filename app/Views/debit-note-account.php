                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <div class="col-md-12 col-sm-12 List p-3">
                            <div class="row">
                                <div class="col-md-10">
                                    <form method="get" action="<?php echo site_url('/debit-note-account'); ?>" enctype="multipart/form-data"> 
                                        <div class="row">
                                                            ...
                                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="">
                                                                            <div class="row">   
                                                                                <form method="post" action="<?php echo site_url('/send-debit-note-to-account'); ?>" enctype="multipart/form-data">
        ...
        <script>
            $(document).ready(function () {
                $('#sendtobillreceivingayaccount').click(function () {
                    ...
                    $.ajax({
                        url: '<?php echo base_url('/index.php/debit-note-to-account') ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: formData,
                        contentType: false,
