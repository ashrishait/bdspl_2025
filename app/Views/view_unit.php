                                             ...
                                             <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body">
                                                      <form method="post" action="<?php echo site_url('/update_unit'); ?>" enctype="multipart/form-data">
                                                         <div class="container">
                                                      ...
                                                      <div class="container">
                                                         ...
                                                         <div class="row">
                                                            <div class="col-sm-12 col-md-12">
                                                               <form method="post" action="<?php echo site_url('/del_unit'); ?>">
                                                                  <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
         ...
         <div class="modal fade bs-example-modal-lg" id="bd-example-modal-lg-Add" tabindex="" role="dialog" aria-labelledby="bd-example-modal-lg-Add" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form method="post" action="<?php echo site_url('/add_unit'); ?>" enctype="multipart/form-data">
                        <input type="hidden" name="compeny_id" value="<?php echo $compeny_id ?>">
                        <div class="container">
                           <!--  <div class="col-sm-12 col-md-4">
                              <div class="form-group">
                                 <label>Department <span style="color:red;">*</span></label>
                                         <select name="department" class="form-control" style="padding: 0.875rem 1.375rem" required id="department" > 
