                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                         ...
                         <h2 class="mb-3 font-weight-bold">Accepted Recived Bill  List</h2>
                        </div>
                        <div class="col-6">
                                           ...
                                           <!--  <a class="btn btn-success btn-sm" href="<?php echo 'view_bill_register_print/'.$row['id']; ?>" target="_blank">View</a>-->
                                               ...
                                               <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-content">
                                                         ...
                                                         <a href="#"><span  data-toggle="modal" data-target="#bd-example-modal-lg-mappBill-<?php echo $row['id']; ?>"><i class="fa fa-eye"></i>Check Up </span></a>
                ...
                <div class="modal-body">
                    <div class="">
                        <div class="row">   
                                ...
                                <form method="post" action="<?php echo site_url('/CheckUp_RecivedBill'); ?>">
                               ...
                               ?>
                                    ...
                                    <div class="form-group">
                                      <label>Remark</label>
                                      <textarea name="Recived_Remark" class="form-control "> 
                                          <?php echo $row['Recived_Remark']; ?>
                                        </textarea>
