                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                         ...
                         <h2 class="mb-3 font-weight-bold">Pending  Clear Bill Form List</h2>
                        </div>
                        <div class="col-6">
                                           ...
                                           <!--  <a class="btn btn-success btn-sm" href="<?php echo 'view_bill_register_print/'.$row['id']; ?>" target="_blank">View</a>-->
                                               ...
                                               <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-content">
                                                         ...
                                                         <a href="#"><span  data-toggle="modal" data-target="#bd-example-modal-lg-Status-<?php echo $row['id']; ?>"><i class="fa fa-eye"></i>Status</span></a>
