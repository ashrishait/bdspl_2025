                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                         ...
                         <h2 class="mb-3 font-weight-bold">Accepted Clear Bill Form List</h2>
                        </div>
                        <div class="col-6">
                                           ...
                                           <!--  <a class="btn btn-success btn-sm" href="<?php echo 'view_bill_register_print/'.$row['id']; ?>" target="_blank">View</a>-->
                                               ...
                                               <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-content">
                                                         ...
                                                         <a href="#"><span  data-toggle="modal" data-target="#bd-example-modal-lg-mappBill-<?php echo $row['id']; ?>"><i class="fa fa-eye"></i>Clear Bill Form </span></a>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h4 class="modal-title text-white" id="myLargeModalLabel">Are You Sure To Clear Bill Form Check Up!</h4>
                ...
                <div class="modal-body">
                    <div class="">
                        <div class="row">   
                                ...
                                <form method="post" action="<?php echo site_url('/CheckUp_Clear_Bill_Form'); ?>">
                                   ...
                                   <?php
                                $time = $Departmentrow['ClearBill_Form_Time_Hours'];
                               ...
                               ?>
                                    ...
                                    <div class="form-group">
                                      <label>Remark</label>
                                      <textarea name="ClearBillForm_Remark" class="form-control "> 
                                          <?php echo $row['ClearBillForm_Remark']; ?>
                                        </textarea>
