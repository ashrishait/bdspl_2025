...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="col-md-12 col-sm-12 List p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-warning btn-lg float-end me-2" data-bs-toggle="modal" data-bs-target="#masteractionModal">
                                            Master Action
                                        </button>
                                        <button type="button" class="btn btn-primary btn-lg float-end me-2" data-bs-toggle="modal" data-bs-target="#billacceptModal">
                                            Accept Bill
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered table-hover" id="myTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><b>Master</b></th>
                                                    <th><b>Master Image</b></th>
                                                    <th><b>Master Remark</b></th>
                                                    <th><b>Image</b></th>
                                                    <th><b>Remark</b></th>
                                                ...
                                                <form method="get" action="<?php echo site_url('/all_erpStystem_list'); ?>" enctype="multipart/form-data"> 
                                                    <tr>
                                                        ...
                                                        <th></th>
                                                        <th></th>
                                                        <th><select name="assignedto" class="form-control" id="assignedto" style="width:130px" onchange="submit()">
                                                ...
                                                if(isset($dax)){
                                                    foreach ($dax as $row){
                                                        ...
                                                        <tr>
                                                            ...
                                                            $rowMasterAction2= $MasterActionmadelObj->where('compeny_id', $compeny_id)->where('stage_id',$stage_id)->where('no_of_action',$row['ERP_Master_Action'])->first();
                                                            ...
                                                            <td><a href="<?php if(isset($rowMasterActionUpload) && $rowMasterActionUpload!='') { if(!empty($rowMasterActionUpload['image_upload'])){ echo base_url('public/vendors/PicUploadMasterAction/'.$rowMasterActionUpload['image_upload']); }else{ }} ?>" target="_blank">link</a></td>
                                                                        ...
                                                                        <div class="">
                                                                            <div class="row">   
                                                                                <form method="post" action="<?php echo site_url('/CheckUp_bill_ERPSytem'); ?>" enctype="multipart/form-data">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select name="Mapping_Acount_EmpId" class="form-control"  style="padding: 0.875rem 1.375rem" required> 
                                                                                                ...
                                                                                                $rowEMP = $EmployeeModelObj
                                                                                                    ...
                                                                                                    ->where('asitek_emp_page_access.Page_Id', 7)
                                                                                                    ->findAll();
                                                                                    ...
                                                                                    <div class="col-sm-12 col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label> Target Time To ERP_Time_Hours Bill</label>
                                                                                            <input type="text" name="Target_ERP_Time_Hours" class="form-control "style="padding: 0.875rem 1.375rem" value="<?php if(!empty($Departmentrow)){echo $Departmentrow['ERP_Time_Hours'];} ?>" readonly > 
                                                                                        </div> 
                                                                                    </div>
                                                                                    <div class="col-sm-12 col-md-6">
                                                                                        <div class="form-group">
                                                            ...
                                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header bg-success">
                                                                        <h4 class="modal-title text-white" id="myLargeModalLabel"> ERP View!</h4>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="">
                                                                            <div class="row">   
                                                                                <form method="post" action="<?php echo site_url('/Department_Mapping_BillReg'); ?>">
                                                                                    ...
                                                                                    <div class="col-sm-12 col-md-6">
                                                                                        <div class="form-group">
                                                                                            <label>Remark</label>
                                                                                            <textarea name="Mapping_Remark" class="form-control "><?php echo $row['ERP_Remark']; ?></textarea>
                                                                                        </div> 
                                                                                    </div>
                                                                                    <div class="col-sm-12 col-md-12">
                                        ...
                                        <div class="">
                                            <div class="row">   
                                                <form method="post" action="">
                                                    ...
                                                    <div class="col-sm-12 col-md-12" >
                                                        <div class="form-group">
                                                            <select name="ERP_Status" id="erpstatus" class="form-control" style="padding: 0.875rem 1.375rem"> 
                                                    ...
                                                    <div class="col-sm-12 col-md-12" >
                                                        <div class="form-group">
                                                            <input type="text" name="ERP_Comment" id="erpcomment" class="form-control" style="padding: 0.875rem 1.375rem"> 
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12">
                                                        <button type="button" class="btn btn-primary btn-lg" id="erpacceptbill">Submit</button>
                                    ...
                                    <div class="modal-body">
                                        <div class="">
                                            <form method="post" action="" enctype="multipart/form-data">  
                                                <div class="row"> 
                                                    <input type="hidden" name="stage_id" id="stage_id" value="4">
                                                    <input type="hidden" name="companyid" id="companyid" class="form-control" value="<?php echo $compeny_id;?>">
                                                    <div class="col-sm-12 col-md-6" >
                                                        <div class="form-group">
                                                            <label>Bill Id</label>
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <button type="button" class="btn btn-warning btn-lg" id="billentryformasteraction">Submit</button>
                                                        <button type="button" class="btn btn-secondary btn-lg" data-bs-dismiss="modal">Close</button>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div class="">
                                            <form method="post" action="" enctype="multipart/form-data">  
                                                <div class="row"> 
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="form-group">
                                                            <label>Account Employee </label>
                                                            <select name="Mapping_Acount_EmpId" id="mappingacountempid" class="form-control"  style="padding: 0.875rem 1.375rem" required> 
                                                                <option value="">-Select -</option> 
                                                                <?php
                                                                $rowEMP = $EmployeeModelObj
                                                                ->select('asitek_employee.*') // Replace 'asitek_employee' with your actual table name
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="Target_ERP_Time_Hours" id="targeterptimehours" class="form-control "style="padding: 0.875rem 1.375rem" value="" readonly > 
                                                        </div> 
                                                    </div>
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="form-group">
                                                            <label> Actual Date & Time</label>
                                                            <input type="text" name="" class="form-control" id="actualdatetime" style="padding: 0.875rem 1.375rem" value="" readonly > 
                                                        </div> 
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-6">
                                                        <div class="form-group">
                                                            <label>Delay Or  On-Time</label>
                                                            <select name="ERP_Delay_On_Time" id="erpdelayontime" class="form-control "style="padding: 0.875rem 1.375rem" > 
                                                                <option value="On-Time" selected>On-Time</option> 
                                                                <option value="Delay" selected>Delay</option> 
        ...
        <script>
            $(document).ready(function () {
                $('#erpacceptbill').click(function () {
                    var companyid    = $('#companyid').val();
                    var billid       = $('#billid').val();
                    var erpstatus    = $('#erpstatus').val();
                    var erpcomment   = $('#erpcomment').val();
    
                    $.ajax({
                        url: '<?php echo base_url('/index.php/erpacceptbill') ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: {
                            companyid    : companyid,
        ...
        <script>
            $(document).ready(function () {
                $('#billentryformasteraction').click(function () {
                    var companyid       = $('#companyid').val();
        ...
        <script>
            $(document).ready(function () {
                $('#sendtobillreceivingayaccount').click(function () {
                    ...
                    var mappingacountempid   = $('#mappingacountempid').val();
                    var targeterptimehours   = $('#targeterptimehours').val();
                    var actualdatetime       = $('#actualdatetime').val();
                    var erpdelayontime       = $('#erpdelayontime').val();
                    var erpremark            = $('#erpremark').val();
                    var E_Image              = $('#billpic')[0].files[0]; // Get the selected file
            
                    var formData = new FormData();
                    formData.append('companyid', companyid);
                    formData.append('billid', billid);
                    formData.append('mappingacountempid', mappingacountempid);
                    formData.append('targeterptimehours', targeterptimehours);
                    formData.append('actualdatetime', actualdatetime);
                    formData.append('erpdelayontime', erpdelayontime);
                    formData.append('erpremark', erpremark);
                    formData.append('E_Image', E_Image);
            
                    $.ajax({
                        url: '<?php echo base_url('/index.php/sendtobillreceiving') ?>',
                        type: 'POST',
                        dataType: 'json',
                        data: formData,
                        contentType: false,
