                     ...
                     <div class="row">
                        <div class="col-md-12 col-sm-12"> 
                           <?php
                              ...
                              {   
                                 ...
                                 {  
                                    echo "<div class='alert alert-danger' role='alert'> Status Updated Successfully. </div>";
                                 }
                                 else{
                                    echo "<div class='alert alert-danger' role='alert'> Problem in operation! </div>";
                                 }
                        ...
                        <div class="col-lg-12">
                             <div class="col-md-12 col-sm-12 List p-3">
                                <div class="row">
                                    <div class="col-6">
                                       <h3 style="font-weight: 600;">Help Support List</h3>
                                    </div>
                                    <div class="col-6">
                                       ...
                                       <tbody>
                                          ...
                                          if(isset($users)){
                                             ...
                                             <tr>
                                                ...
                                                <td><?php 
                                                   $Compenyrow= $CompenyModelObj->where('id',$row['company_id'])->first();
                                                ...
                                                <td>
                                                 <?php if($row['Status'] == 'open' || $row['Status'] == 'Open' || $row['Status'] == 'In Progress') { ?>
                                                    ...
                                                    <a class="btn btn-primary btn-sm" href="<?php echo base_url();?>/index.php/complete-detail-of-help-support/<?php echo $row['Id']; ?>"><span class="mdi mdi-eye-circle"></span></a>
                                                 <?php } else { ?>
                                                        ...
                                                        <div class="modal-dialog modal-md modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-primary">
                                                                    <h4 class="modal-title text-white" id="myLargeModalLabel">Are you sure you want to change status </h4>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="">
                                                                        <div class="row">   
                                                <form method="post" action="<?php echo site_url('/Recived_Help_StatusChange'); ?>">
