        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-12 pb-24 md:pb-5">
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                    <h3 class="font-bold pl-2"><?php echo $companyname;?> Bill Status</h3>
                </div>
            </div>
                    ...
                    <div class="w-full md:w-full xl:w-full p-6">
                        ...
                        <div class="bg-gradient-to-b from-grey-200 to-grey-100 border-b-4 border-grey-600 rounded-lg shadow-xl p-5">
                            <div class="items-center">
                                <form method="post" action="<?php echo site_url();?>/vendor-set-startdate-enddate-on-companypage" enctype="multipart/form-data">
                                    <input type="hidden" name="compeny_id" value="<?php echo $companyid;?>">
                                        ...
                                        foreach ($users as $index => $row)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td class="border border-slate-300 p-2">
                                                    ...
                                                    { 
                                                        ...
                                                        { 
                                                            ...
                                                            $rowMasterAction2= $MasterActionmadelObj->where('compeny_id', $companyid)->where('stage_id',3)->where('no_of_action',$row['ClearFormBill_Master_Action'])->first();
                                                            
                                                            if(isset($rowMasterAction2) && $rowMasterAction2!='')
                                                            {
                                                                $rowMasterActionUpload= $MasterActionUploadModelObj->where('compeny_id', $companyid)->where('bill_id',$row['id'])->where('master_action_id',$rowMasterAction2['id'])->first();
                                                        ...
                                                        elseif($row['Clear_Bill_Form_Status']=='3'){
                                                            ...
                                                            elseif($row['ERP_Status']=='2'){ 
                                                                $MasterActionmadelObj = new MasterActionModel();
                                                                $rowMasterActionerp= $MasterActionmadelObj->where('compeny_id', $companyid)->where('stage_id',4)->where('no_of_action',$row['ERP_Master_Action'])->first();
                                                                if(isset($rowMasterActionerp) && $rowMasterActionerp!='')
                                                                {
                                                                    $rowMasterActionUploaderp= $MasterActionUploadModelObj->where('compeny_id', $companyid)->where('bill_id',$row['id'])->where('master_action_id',$rowMasterActionerp['id'])->first();
                                                            ...
                                                            elseif($row['ERP_Status']=='3'){ 
                                                                ...
                                                                elseif($row['Recived_Status']=='2'){ 
                                                                    $MasterActionmadelObj = new MasterActionModel();
                                                                    $rowMasterActionrec= $MasterActionmadelObj->where('compeny_id', $companyid)->where('stage_id',5)->where('no_of_action',$row['Recived_Master_Action'])->first();
                                                                    if(isset($rowMasterActionrec) && $rowMasterActionrec!='')
                                                                    {
                                                                        $rowMasterActionUploadrec= $MasterActionUploadModelObj->where('compeny_id', $companyid)->where('bill_id',$row['id'])->where('master_action_id',$rowMasterActionrec['id'])->first();
                                                ...
                                                <td class="border border-slate-300 p-2">
                                                    ...
                                                    <button class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="authentication-modal<?php echo $row['uid'];?>">
                                                        <i class="fas fa-comments fa-2x fa-inverse"></i>
                                                    </button>
                                                </td>
                                            ...
                                            <div id="authentication-modal<?php echo $row['uid'];?>" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                                            ...
                                                            <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="authentication-modal<?php echo $row['uid'];?>">
