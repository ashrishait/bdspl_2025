                                                ...
                                                if(isset($dax)){
                                                    foreach ($dax as $row){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo date('d-m-Y', strtotime($row['Gate_Entry_Date']))?></td>
                                                            <td><?php 
                                                            ...
                                                            <td><?php echo date('d-m-Y', strtotime($row['Bill_Acceptation_DateTime']))?></td>
                                                            <td><?php if($row['Clear_Bill_Form_Status']=='1'){ echo "Pending"; }elseif($row['Clear_Bill_Form_Status']=='2'){ echo "Accepted"; }elseif($row['Clear_Bill_Form_Status']=='3'){ echo "Rejected"; }else{ echo "Done"; } ?></td>
                                                        </tr> 
                                                        <?php 
                                                    } 
                                                } 
