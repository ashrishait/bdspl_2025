                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                         ...
                         <h2 class="mb-3 font-weight-bold">Accepted  Bill ERP Sytem List</h2>
                        </div>
                        <div class="col-6">
                ...
                <div class="modal-body">
                    <div class="">
                        <div class="row">   
                                ...
                                <form method="post" action="<?php echo site_url('/CheckUp_bill_ERPSytem'); ?>">
                               ...
                               ?>
                                    ...
                                    <div class="form-group">
                                      <label>Remark</label>
                                      <textarea name="ERP_Remark" class="form-control "> 
